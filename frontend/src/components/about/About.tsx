    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto p-6 space-y-8">
                <h1 className="text-4xl font-bold text-center text-pvPetrel">About Us</h1>
                ...
                <section className="space-y-4">
                    ...
                    <p className="dark:text-gray-400">
                        ...
                        <span className="font-bold">Koya</span>, a passionate web developer focused
                        on crafting efficient and visually appealing web applications.
                    </p>
                </section>
                <section className="space-y-4">
